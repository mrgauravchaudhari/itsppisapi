...
{
    public class PLR201ReportModel
    {
        ...
        public decimal NR_L_SULPHUR { get; set; }
        public decimal NR_L_RESIDUE { get; set; }
        public decimal NR_L_RECOVERY { get; set; }
        public decimal NR_L_LIQ_REMAIN { get; set; }
        public decimal NR_L_LOSS { get; set; }
