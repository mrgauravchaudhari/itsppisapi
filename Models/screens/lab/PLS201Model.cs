namespace itsppisapi.Models
{
    public class PLS201Model
    {
        ...
        public string L_AR3A_DENSITY { get; set; }
        public string L_TANK_DENSITY_BF_UNLDG_15C { get; set; }
        public string L_TANK_DENSITY_BF_UNLDG { get; set; }
        public string L_TANK_DENSITY_AF_UNLDG_15C { get; set; }
        public string L_TANK_DENSITY_AF_UNLDG { get; set; }
