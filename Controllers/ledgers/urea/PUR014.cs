...
namespace cfclapi.Controllers.ledgers.electrical
{
    ...
    public class PUR014Controller : ControllerBase
    {
        private string _connectionString;

        private readonly itsppisapi.Models.DataContext _context;
        public PUR014Controller(itsppisapi.Models.DataContext context)
        {
            _context = context;
        }
        ...
        public async Task<DataSet> get(string mnth)
        {
            try
            {
                string strqry = "[PPIS].[PPU_P_UR1_ML_STEAM_WATER_CONSP_PUR014]";
