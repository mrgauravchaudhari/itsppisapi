...
namespace cfclapi.Controllers.ledgers.electrical
{
    ...
    public class PUR013Controller : ControllerBase
    {
        private string _connectionString;

        private readonly itsppisapi.Models.DataContext _context;
        public PUR013Controller(itsppisapi.Models.DataContext context)
        {
            _context = context;
        }
        ...
        public async Task<DataSet> get(string mnth)
        {
            try
            {
                string strqry = "[PPIS].[PPU_P_UR1_ML_PROD_RAW_MATERIAL_CONSP_PUR013]";
