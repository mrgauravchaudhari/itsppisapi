...
namespace cfclapi.Controllers.ledgers.electrical
{
    ...
    public class PAR273Controller : ControllerBase
    {
        private string _connectionString;

        private readonly itsppisapi.Models.DataContext _context;
        public PAR273Controller(itsppisapi.Models.DataContext context)
        {
            _context = context;
        }
        ...
        public async Task<DataSet> get(string month)
        {
            try
            {
               string strqry = "[PPIS].[PPU_P_AM2_ML_Alloc_UTIL_GP3_TO_GP1_PAR273]";
