...
namespace cfclapi.Controllers.ledgers.electrical
{
    ...
    public class PAR271Controller : ControllerBase
    {
        private string _connectionString;

        private readonly itsppisapi.Models.DataContext _context;
        public PAR271Controller(itsppisapi.Models.DataContext context)
        {
            _context = context;
        }
        ...
        public async Task<DataSet> get(string month)
        {
            try
            {
               string strqry = "[PPIS].[PPU_P_AM2_ML_ALLOC_NG_NAPTHA_UTIL_PAR271]";
