...
namespace cfclapi.Controllers.ledgers.electrical
{
    ...
    public class PAR256Controller : ControllerBase
    {
        private string _connectionString;

        private readonly itsppisapi.Models.DataContext _context;
        public PAR256Controller(itsppisapi.Models.DataContext context)
        {
            _context = context;
        }
        ...
        public async Task<DataSet> get(string month)
        {
            try
            {
                string strqry = "[PPIS].[PPU_P_AM2_YL_ALLOC_NG_NAPTHA_UTIL_PAR256]";
