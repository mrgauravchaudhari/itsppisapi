...
namespace cfclapi.Controllers.ledgers.electrical
{
    ...
    public class PAR233Controller : ControllerBase
    {
        private string _connectionString;

        private readonly itsppisapi.Models.DataContext _context;
        public PAR233Controller(itsppisapi.Models.DataContext context)
        {
            _context = context;
        }
        ...
        public async Task<DataSet> get(string month)
        {
            try
            {
                string strqry = "PPIS.PPU_P_AM2_ML_NATURAL_GAS_PROPERTY_CALC_PAR233";
