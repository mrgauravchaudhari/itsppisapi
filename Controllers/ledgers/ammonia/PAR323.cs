...
namespace cfclapi.Controllers.ledgers.electrical
{
    ...
    public class PAR323Controller : ControllerBase
    {
        private string _connectionString;

        private readonly itsppisapi.Models.DataContext _context;
        public PAR323Controller(itsppisapi.Models.DataContext context)
        {
            _context = context;
        }
        ...
        public async Task<DataSet> get(string month)
        {
            try
            {
                string strqry = "PPIS.PPU_P_AM3_ML_ALLOC_NATURAL_GAS_AGAINST_UTIL_PAR323";
