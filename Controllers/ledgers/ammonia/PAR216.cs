...
namespace cfclapi.Controllers.ledgers.electrical
{
    ...
    public class PAR216Controller : ControllerBase
    {
        private string _connectionString;

        private readonly itsppisapi.Models.DataContext _context;
        public PAR216Controller(itsppisapi.Models.DataContext context)
        {
            _context = context;
        }
        ...
        public async Task<DataSet> get(string month)
        {
            try
            {
               string strqry = "[PPIS].[PPU_P_AM2_ML_COOLING_TOWER_EFF_PAR216]";
