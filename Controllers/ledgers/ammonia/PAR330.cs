...
namespace cfclapi.Controllers.ledgers.electrical
{
    ...
    public class PAR330Controller : ControllerBase
    {
        private string _connectionString;

        private readonly itsppisapi.Models.DataContext _context;
        public PAR330Controller(itsppisapi.Models.DataContext context)
        {
            _context = context;
        }
        ...
        public async Task<DataSet> get(string month)
        {
            try
            {
                string strqry = "PPIS.PPU_P_AM3_ML_GTG3_POWER_ALLOC_PAR330";
