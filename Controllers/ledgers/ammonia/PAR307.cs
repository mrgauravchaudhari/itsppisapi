...
namespace cfclapi.Controllers.ledgers.electrical
{
    ...
    public class PAR307Controller : ControllerBase
    {
        private string _connectionString;

        private readonly itsppisapi.Models.DataContext _context;
        public PAR307Controller(itsppisapi.Models.DataContext context)
        {
            _context = context;
        }
        ...
        public async Task<DataSet> get(string month)
        {
            try
            {
                string strqry = "[PPIS].[PPU_P_AM3_ML_GAS_ERROR_STATEMENT_PAR307]";
