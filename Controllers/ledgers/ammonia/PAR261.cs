...
namespace cfclapi.Controllers.ledgers.electrical
{
    ...
    public class PAR261Controller : ControllerBase
    {
        private string _connectionString;

        private readonly itsppisapi.Models.DataContext _context;
        public PAR261Controller(itsppisapi.Models.DataContext context)
        {
            _context = context;
        }
        ...
        public async Task<DataSet> get(string month)
        {
            try
            {
               string strqry = "[PPIS].PPU_P_OU2_ML_LOG_SHEET_WASTE_WATER_PAR261";
