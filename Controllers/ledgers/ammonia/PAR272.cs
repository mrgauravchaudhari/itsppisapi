...
namespace cfclapi.Controllers.ledgers.electrical
{
    ...
    public class PAR272Controller : ControllerBase
    {
        private string _connectionString;

        private readonly itsppisapi.Models.DataContext _context;
        public PAR272Controller(itsppisapi.Models.DataContext context)
        {
            _context = context;
        }
        ...
        public async Task<DataSet> get(string month)
        {
            try
            {
               string strqry = "[PPIS].[PPU_P_AM2_ML_BIF_NG_EXP_TO_SSP_PAR272]";
