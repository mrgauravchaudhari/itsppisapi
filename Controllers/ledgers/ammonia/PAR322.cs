...
namespace cfclapi.Controllers.ledgers.electrical
{
    ...
    public class PAR322Controller : ControllerBase
    {
        private string _connectionString;

        private readonly itsppisapi.Models.DataContext _context;
        public PAR322Controller(itsppisapi.Models.DataContext context)
        {
            _context = context;
        }
        ...
        public async Task<DataSet> get(string month)
        {
            try
            {
                string strqry = "ppis.PPU_P_AM3_YL_SPECIFIC_ENERGY_PAR322";
