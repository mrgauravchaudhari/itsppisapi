...
namespace cfclapi.Controllers.ledgers.electrical
{
    ...
    public class PAR238Controller : ControllerBase
    {
        private string _connectionString;

        private readonly itsppisapi.Models.DataContext _context;
        public PAR238Controller(itsppisapi.Models.DataContext context)
        {
            _context = context;
        }
        ...
        public async Task<DataSet> get(string month)
        {
            try
            {
               string strqry = "[PPIS].[PPU_P_AM2_YL_WATER_BAL_PLW_DIST_SHEET_PAR238]";
