...
namespace cfclapi.Controllers.ledgers.electrical
{
    ...
    public class PAR013Controller : ControllerBase
    {
        private string _connectionString;

        private readonly itsppisapi.Models.DataContext _context;
        public PAR013Controller(itsppisapi.Models.DataContext context)
        {
            _context = context;
        }
        ...
        public async Task<DataSet> get(string month)
        {
            try
            {
                string strqry = "[PPIS].[PPU_P_AM1_ML_ALLOC_NG_NAPHTHA_GPII_PAR013]";
