...
namespace cfclapi.Controllers.ledgers.electrical
{
    ...
    public class PAR229Controller : ControllerBase
    {
        private string _connectionString;

        private readonly itsppisapi.Models.DataContext _context;
        public PAR229Controller(itsppisapi.Models.DataContext context)
        {
            _context = context;
        }
        ...
        public async Task<DataSet> get(string month)
        {
            try
            {
               string strqry = "PPIS.PPU_P_AM2_ML_NAPHTHA_ERROR_STMT_PAR229";
