...
namespace cfclapi.Controllers.ledgers.electrical
{
    ...
    public class PAR306Controller : ControllerBase
    {
        private string _connectionString;

        private readonly itsppisapi.Models.DataContext _context;
        public PAR306Controller(itsppisapi.Models.DataContext context)
        {
            _context = context;
        }
        ...
        public async Task<DataSet> get(string month)
        {
            try
            {
               string strqry = "[PPIS].[PPU_P_AM3_YL_NITROGEN_PROD_CONS_PAR306]";
