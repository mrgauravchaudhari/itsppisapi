...
namespace cfclapi.Controllers.ledgers.electrical
{
    ...
    public class PAR029Controller : ControllerBase
    {
        private string _connectionString;

        private readonly itsppisapi.Models.DataContext _context;
        public PAR029Controller(itsppisapi.Models.DataContext context)
        {
            _context = context;
        }
        ...
        public async Task<DataSet> get(string month)
        {
            try
            {
                string strqry = "[PPIS].[PPU_P_AM1_YL_BIFURCATION_NG_EXPORT_GPI_TO_GPII_PAR029]";
