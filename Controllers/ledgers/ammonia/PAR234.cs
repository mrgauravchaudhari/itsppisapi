...
namespace cfclapi.Controllers.ledgers.electrical
{
    ...
    public class PAR234Controller : ControllerBase
    {
        private string _connectionString;

        private readonly itsppisapi.Models.DataContext _context;
        public PAR234Controller(itsppisapi.Models.DataContext context)
        {
            _context = context;
        }
        ...
        public async Task<DataSet> get(string month)
        {
            try
            {
               string strqry = "[PPIS].[PPU_P_AM2_YL_PROD_NATURAL_GAS_DIST_PAR234]";
