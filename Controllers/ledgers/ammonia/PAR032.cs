...
namespace cfclapi.Controllers.ledgers.electrical
{
    ...
    public class PAR032Controller : ControllerBase
    {
        private string _connectionString;

        private readonly itsppisapi.Models.DataContext _context;
        public PAR032Controller(itsppisapi.Models.DataContext context)
        {
            _context = context;
        }
        ...
        public async Task<DataSet> get(string month)
        {
            try
            {
                string strqry = "[PPIS].[PPU_P_AM1_ML_ALLOC_UTILITIES_GPIII_TO_GPI_PAR032]";
