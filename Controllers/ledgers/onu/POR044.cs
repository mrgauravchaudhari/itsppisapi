...
namespace cfclapi.Controllers.ledgers.electrical
{
    ...
    public class POR044Controller : ControllerBase
    {
        private string _connectionString;

        private readonly itsppisapi.Models.DataContext _context;
        public POR044Controller(itsppisapi.Models.DataContext context)
        {
            _context = context;
        }
        ...
        public async Task<DataSet> get(string month)
        {
            try
            {
               string strqry = "PPIS.PPU_P_OU1_ML_NG_PROPERTIES_CALC_SHEET_POR044";
