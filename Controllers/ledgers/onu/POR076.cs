...
namespace cfclapi.Controllers.ledgers.electrical
{
    ...
    public class POR076Controller : ControllerBase
    {
        private string _connectionString;

        private readonly itsppisapi.Models.DataContext _context;
        public POR076Controller(itsppisapi.Models.DataContext context)
        {
            _context = context;
        }
        ...
        public async Task<DataSet> get(string month)
        {
            try
            {
                string strqry = "[PPIS].[PPU_P_OU1_ML_FEED_WATER_BLOWDOWN_DTL_POR076]";
