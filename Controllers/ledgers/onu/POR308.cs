...
namespace cfclapi.Controllers.ledgers.electrical
{
    ...
    public class POR308Controller : ControllerBase
    {
        private string _connectionString;

        private readonly itsppisapi.Models.DataContext _context;
        public POR308Controller(itsppisapi.Models.DataContext context)
        {
            _context = context;
        }
        ...
        public async Task<DataSet> get(string month)
        {
            try
            {
               string strqry = "[PPIS].ppu_P_ou3_YL_waste_water_Log_Sheet_POR308";
