...
namespace cfclapi.Controllers.ledgers.electrical
{
    ...
    public class POR072Controller : ControllerBase
    {
        private string _connectionString;

        private readonly itsppisapi.Models.DataContext _context;
        public POR072Controller(itsppisapi.Models.DataContext context)
        {
            _context = context;
        }
        ...
        public async Task<DataSet> get(string month)
        {
            try
            {
               string strqry = "ppis.PPU_P_OU1_YL_UCT_PERFORMANCE_POR072";
