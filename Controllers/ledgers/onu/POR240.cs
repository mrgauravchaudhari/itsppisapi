...
namespace cfclapi.Controllers.ledgers.electrical
{
    ...
    public class POR240Controller : ControllerBase
    {
        private string _connectionString;

        private readonly itsppisapi.Models.DataContext _context;
        public POR240Controller(itsppisapi.Models.DataContext context)
        {
            _context = context;
        }
        ...
        public async Task<DataSet> get(string month)
        {
            try
            {
                string strqry = "ppis.PPU_P_OU1_YL_DM_WATER_BALANCE_GP_I_POR240";
