...
namespace cfclapi.Controllers.ledgers.electrical
{
    ...
    public class POR088Controller : ControllerBase
    {
        private string _connectionString;

        private readonly itsppisapi.Models.DataContext _context;
        public POR088Controller(itsppisapi.Models.DataContext context)
        {
            _context = context;
        }
        ...
        public async Task<DataSet> get(string month)
        {
            try
            {
               string strqry = "[PPIS].[PPU_P_OU1_ML_PROCESS_WATER_CONS_POR088]";
