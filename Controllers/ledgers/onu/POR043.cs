...
namespace cfclapi.Controllers.ledgers.electrical
{
    ...
    public class POR043Controller : ControllerBase
    {
        private string _connectionString;

        private readonly itsppisapi.Models.DataContext _context;
        public POR043Controller(itsppisapi.Models.DataContext context)
        {
            _context = context;
        }
        ...
        public async Task<DataSet> get(string month)
        {
            try
            {
                string strqry = "[PPIS].[PPU_P_OU1_YL_HR_RATE_RW_FW_GEN_CONS_POR043]";
