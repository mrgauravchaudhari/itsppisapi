...
namespace cfclapi.Controllers.ledgers.electrical
{
    ...
    public class POR311Controller : ControllerBase
    {
        private string _connectionString;

        private readonly itsppisapi.Models.DataContext _context;
        public POR311Controller(itsppisapi.Models.DataContext context)
        {
            _context = context;
        }
        ...
        public async Task<DataSet> get(string month)
        {
            try
            {
               string strqry = "PPIS.ppu_P_ou3_ML_POLISH_WATER_GP3_POR311";
