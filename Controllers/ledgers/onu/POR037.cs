...
namespace cfclapi.Controllers.ledgers.electrical
{
    ...
    public class POR037Controller : ControllerBase
    {
        private string _connectionString;

        private readonly itsppisapi.Models.DataContext _context;
        public POR037Controller(itsppisapi.Models.DataContext context)
        {
            _context = context;
        }
        ...
        public async Task<DataSet> get(string month)
        {
            try
            {
               string strqry = "ppis.PPU_P_OU1_YL_SP_CONSP_EFF_CALC_AUX_BOILERS_POR037";
