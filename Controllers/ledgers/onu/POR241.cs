...
namespace cfclapi.Controllers.ledgers.electrical
{
    ...
    public class POR241Controller : ControllerBase
    {
        private string _connectionString;

        private readonly itsppisapi.Models.DataContext _context;
        public POR241Controller(itsppisapi.Models.DataContext context)
        {
            _context = context;
        }
        ...
        public async Task<DataSet> get(string month)
        {
            try
            {
               string strqry = "ppis.PPU_P_OU1_YL_DM_WATER_BALANCE_GP_II_POR241";
