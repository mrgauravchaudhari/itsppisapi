...
namespace cfclapi.Controllers.ledgers.electrical
{
    ...
    public class POR228Controller : ControllerBase
    {
        private string _connectionString;

        private readonly itsppisapi.Models.DataContext _context;
        public POR228Controller(itsppisapi.Models.DataContext context)
        {
            _context = context;
        }
        ...
        public async Task<DataSet> get(string month)
        {
            try
            {
                string strqry = "PPIS.PPU_P_OU2_YL_COMP_GAS_CONS_DIST_POR228";
