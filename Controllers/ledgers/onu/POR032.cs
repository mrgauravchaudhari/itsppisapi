...
namespace cfclapi.Controllers.ledgers.electrical
{
    ...
    public class POR032Controller : ControllerBase
    {
        private string _connectionString;

        private readonly itsppisapi.Models.DataContext _context;
        public POR032Controller(itsppisapi.Models.DataContext context)
        {
            _context = context;
        }
        ...
        public async Task<DataSet> get(string month)
        {
            try
            {
               string strqry = "[PPIS].[PPU_P_OU1_YL_KS_LS_STEAM_DTL_POR032]";
