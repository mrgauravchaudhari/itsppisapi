...
namespace cfclapi.Controllers.ledgers.electrical
{
    ...
    public class POR046Controller : ControllerBase
    {
        private string _connectionString;

        private readonly itsppisapi.Models.DataContext _context;
        public POR046Controller(itsppisapi.Models.DataContext context)
        {
            _context = context;
        }
        ...
        public async Task<DataSet> get(string month)
        {
            try
            {
                string strqry = "PPIS.PPU_P_OU1_ML_NG_CF_CALC_SHEET_GT_POR046";
