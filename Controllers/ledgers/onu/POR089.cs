...
namespace cfclapi.Controllers.ledgers.electrical
{
    ...
    public class POR089Controller : ControllerBase
    {
        private string _connectionString;

        private readonly itsppisapi.Models.DataContext _context;
        public POR089Controller(itsppisapi.Models.DataContext context)
        {
            _context = context;
        }
        ...
        public async Task<DataSet> get(string month)
        {
            try
            {
               string strqry = "PPIS.PPU_P_OU1_YL_PROCESS_WATER_CONS_POR089";
