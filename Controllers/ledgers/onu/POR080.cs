...
namespace cfclapi.Controllers.ledgers.electrical
{
    ...
    public class POR080Controller : ControllerBase
    {
        private string _connectionString;

        private readonly itsppisapi.Models.DataContext _context;
        public POR080Controller(itsppisapi.Models.DataContext context)
        {
            _context = context;
        }
        ...
        public async Task<DataSet> get(string month)
        {
            try
            {
                string strqry = "PPIS.PPU_P_OU1_ML_DM_WATER_BALANCE_GP_I_POR080";
