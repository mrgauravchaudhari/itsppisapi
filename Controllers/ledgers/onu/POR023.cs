...
namespace cfclapi.Controllers.ledgers.electrical
{
    ...
    public class POR023Controller : ControllerBase
    {
        private string _connectionString;

        private readonly itsppisapi.Models.DataContext _context;
        public POR023Controller(itsppisapi.Models.DataContext context)
        {
            _context = context;
        }
        ...
        public async Task<DataSet> get(string month)
        {
            try
            {
                string strqry = "PPIS.PPU_P_OU1_ML_SP_CONSP_EFF_GTG_II_POR023";
