...
namespace cfclapi.Controllers.ledgers.electrical
{
    ...
    public class POR230Controller : ControllerBase
    {
        private string _connectionString;

        private readonly itsppisapi.Models.DataContext _context;
        public POR230Controller(itsppisapi.Models.DataContext context)
        {
            _context = context;
        }
        ...
        public async Task<DataSet> get(string month)
        {
            try
            {
                string strqry = "PPIS.PPU_P_OU2_YL_COMP_WATER_CONS_DIST_GPII_POR230";
