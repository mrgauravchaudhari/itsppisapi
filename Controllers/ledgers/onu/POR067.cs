...
namespace cfclapi.Controllers.ledgers.electrical
{
    ...
    public class POR067Controller : ControllerBase
    {
        private string _connectionString;

        private readonly itsppisapi.Models.DataContext _context;
        public POR067Controller(itsppisapi.Models.DataContext context)
        {
            _context = context;
        }
        ...
        public async Task<DataSet> get(string month)
        {
            try
            {
                string strqry = "ppis.PPU_P_OU1_YL_NG_PROPERTIES_CALC_SHEET_POR067";
