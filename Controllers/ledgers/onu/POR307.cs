...
namespace cfclapi.Controllers.ledgers.electrical
{
    ...
    public class POR307Controller : ControllerBase
    {
        private string _connectionString;

        private readonly itsppisapi.Models.DataContext _context;
        public POR307Controller(itsppisapi.Models.DataContext context)
        {
            _context = context;
        }
        ...
        public async Task<DataSet> get(string month)
        {
            try
            {
               string strqry = "ppis.ppu_P_ou3_ML_waste_water_Log_Sheet_POR307";
