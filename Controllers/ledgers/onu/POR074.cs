...
namespace cfclapi.Controllers.ledgers.electrical
{
    ...
    public class POR074Controller : ControllerBase
    {
        private string _connectionString;

        private readonly itsppisapi.Models.DataContext _context;
        public POR074Controller(itsppisapi.Models.DataContext context)
        {
            _context = context;
        }
        ...
        public async Task<DataSet> get(string month)
        {
            try
            {
                string strqry = "[PPIS].[PPU_P_OU1_YL_UTILITY_CONSUMED_POR074]";
