...
namespace cfclapi.Controllers.ledgers.electrical
{
    ...
    public class POR040Controller : ControllerBase
    {
        private string _connectionString;

        private readonly itsppisapi.Models.DataContext _context;
        public POR040Controller(itsppisapi.Models.DataContext context)
        {
            _context = context;
        }
        ...
        public async Task<DataSet> get(string month)
        {
            try
            {
               string strqry = "ppis.PPU_P_OU1_YL_GEN_CONSP_VARIOUS_UTIL_PER_TON_UREA_PROD_POR040";
