...
namespace cfclapi.Controllers.ledgers.electrical
{
    ...
    public class POR247Controller : ControllerBase
    {
        private string _connectionString;

        private readonly itsppisapi.Models.DataContext _context;
        public POR247Controller(itsppisapi.Models.DataContext context)
        {
            _context = context;
        }
        ...
        public async Task<DataSet> get(string month)
        {
            try
            {
                string strqry = "[PPIS].[PPU_P_OU2_ML_CHEMICALS_BOOKING_TO_CFG3_POR247]";
