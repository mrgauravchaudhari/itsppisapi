...
namespace cfclapi.Controllers.ledgers.electrical
{
    ...
    public class POR042Controller : ControllerBase
    {
        private string _connectionString;

        private readonly itsppisapi.Models.DataContext _context;
        public POR042Controller(itsppisapi.Models.DataContext context)
        {
            _context = context;
        }
        ...
        public async Task<DataSet> get(string month)
        {
            try
            {
               string strqry = "ppis.PPU_P_OU1_YL_HRLY_RATES_DM_PW_PROD_DIST_POR042";
