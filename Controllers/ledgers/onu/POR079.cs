...
namespace cfclapi.Controllers.ledgers.electrical
{
    ...
    public class POR079Controller : ControllerBase
    {
        private string _connectionString;

        private readonly itsppisapi.Models.DataContext _context;
        public POR079Controller(itsppisapi.Models.DataContext context)
        {
            _context = context;
        }
        ...
        public async Task<DataSet> get(string month)
        {
            try
            {
                string strqry = "[PPIS].[PPU_P_OU1_ML_NITROGEN_PROD_CONS_DTL_POR079]";
