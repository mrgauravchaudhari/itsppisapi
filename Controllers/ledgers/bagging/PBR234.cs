...
namespace cfclapi.Controllers.ledgers.electrical
{
    ...
    public class PBR234Controller : ControllerBase
    {
        private string _connectionString;

        private readonly itsppisapi.Models.DataContext _context;
        public PBR234Controller(itsppisapi.Models.DataContext context)
        {
            _context = context;
        }
        ...
        public async Task<DataSet> get(string month)
        {
            try
            {
                string strqry = "[PPIS].[PPU_P_BG_ML_NEEM_GP3_OIL_DETAILS_PBR234]";
