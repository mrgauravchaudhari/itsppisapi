...
namespace cfclapi.Controllers.ledgers.electrical
{
    ...
    public class PBR233Controller : ControllerBase
    {
        private string _connectionString;

        private readonly itsppisapi.Models.DataContext _context;
        public PBR233Controller(itsppisapi.Models.DataContext context)
        {
            _context = context;
        }
        ...
        public async Task<DataSet> get(string month)
        {
            try
            {
                string strqry = "[PPIS].[PPU_P_BG_ML_SLAT_WISE_BAGGING_DTLS_PBR233]";
