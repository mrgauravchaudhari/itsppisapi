...
namespace cfclapi.Controllers.ledgers.electrical
{
    ...
    public class PBR232Controller : ControllerBase
    {
        private string _connectionString;

        private readonly itsppisapi.Models.DataContext _context;
        public PBR232Controller(itsppisapi.Models.DataContext context)
        {
            _context = context;
        }
        ...
        public async Task<DataSet> get(string month)
        {
            try
            {
                string strqry = "[PPIS].[PPU_P_BG_ML_UREA_DISSOLVING_BAG_DETAILS_PBR232]";
