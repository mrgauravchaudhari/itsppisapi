...
namespace cfclapi.Controllers.ledgers.electrical
{
    ...
    public class PBR230Controller : ControllerBase
    {
        private string _connectionString;

        private readonly itsppisapi.Models.DataContext _context;
        public PBR230Controller(itsppisapi.Models.DataContext context)
        {
            _context = context;
        }
        ...
        public async Task<DataSet> get(string month)
        {
            try
            {
                string strqry = "[PPIS].[PPU_P_BG_ML_DEMURRAGE_HOUR_DTLS_PBR230]";
