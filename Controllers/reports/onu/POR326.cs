...
namespace cfclapi.Controllers.ledgers.electrical
{
    ...
    public class POR326Controller : ControllerBase
    {
        private string _connectionString;

        private readonly itsppisapi.Models.DataContext _context;
        public POR326Controller(itsppisapi.Models.DataContext context)
        {
            _context = context;
        }
        ...
        public async Task<DataSet> get(string month)
        {
            try
            {
                string strqry = "PPIS.PPU_P_OU3_MR_EFF_GEN_AND_DIST_POR326";
