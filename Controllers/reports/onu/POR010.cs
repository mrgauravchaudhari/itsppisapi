...
namespace cfclapi.Controllers.ledgers.electrical
{
    ...
    public class POR010Controller : ControllerBase
    {
        private string _connectionString;

        private readonly itsppisapi.Models.DataContext _context;
        public POR010Controller(itsppisapi.Models.DataContext context)
        {
            _context = context;
        }
        ...
        public async Task<DataSet> get(string month)
        {
            try
            {
                string strqry = "PPIS.PPU_P_OU1_MR_RECEIPT_DIST_WATER_POR010";
