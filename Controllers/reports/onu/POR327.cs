...
namespace cfclapi.Controllers.ledgers.electrical
{
    ...
    public class POR327Controller : ControllerBase
    {
        private string _connectionString;

        private readonly itsppisapi.Models.DataContext _context;
        public POR327Controller(itsppisapi.Models.DataContext context)
        {
            _context = context;
        }
        ...
        public async Task<DataSet> get(string month)
        {
            try
            {
                string strqry = "PPIS.PPU_P_OU3_DR_GEN_DIS_UTILITY_POR327";
