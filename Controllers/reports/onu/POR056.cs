...
namespace cfclapi.Controllers.ledgers.electrical
{
    ...
    public class POR056Controller : ControllerBase
    {
        private string _connectionString;

        private readonly itsppisapi.Models.DataContext _context;
        public POR056Controller(itsppisapi.Models.DataContext context)
        {
            _context = context;
        }
        ...
        public async Task<DataSet> get(string month)
        {
            try
            {
               string strqry = "PPIS.PPU_P_OU1_MR_CHEMICAL_CONS_STOCK_POR056";
