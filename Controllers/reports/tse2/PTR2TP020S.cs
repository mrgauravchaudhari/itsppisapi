...
namespace cfclapi.Controllers.ledgers.electrical
{
    ...
    public class PTR2TP020SController : ControllerBase
    {
        private string _connectionString;

        private readonly itsppisapi.Models.DataContext _context;
        public PTR2TP020SController(itsppisapi.Models.DataContext context)
        {
            _context = context;
        }
        ...
        public async Task<DataSet> get(string month, int vers)
        {
            try
            {
                string strqry = "[PPIS].PPU_P_TSE2_YR_CONS_PURCH_INPUT_PTR2TOP020S";
