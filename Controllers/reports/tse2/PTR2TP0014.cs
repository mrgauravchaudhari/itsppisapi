...
namespace cfclapi.Controllers.ledgers.electrical
{
    ...
    public class PTR2TP0014Controller : ControllerBase
    {
        private string _connectionString;

        private readonly itsppisapi.Models.DataContext _context;
        public PTR2TP0014Controller(itsppisapi.Models.DataContext context)
        {
            _context = context;
        }
        ...
        public async Task<DataSet> get(string month, int vers)
        {
            try
            {
                string strqry = "PPIS.PPU_P_TSE2_YR_NG_ELECTRICITY_BAL_PTR2TOP0014";
