...
namespace cfclapi.Controllers.ledgers.electrical
{
    ...
    public class PTR2TP1905Controller : ControllerBase
    {
        private string _connectionString;

        private readonly itsppisapi.Models.DataContext _context;
        public PTR2TP1905Controller(itsppisapi.Models.DataContext context)
        {
            _context = context;
        }
        ...
        public async Task<DataSet> get(string month, int vers, string id)
        {
            try
            {
                string strqry = "[PPIS].[PPU_TSE2_YR_UREA_PTR2TOP1905Y2018]";
