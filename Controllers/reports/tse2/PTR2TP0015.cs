...
namespace cfclapi.Controllers.ledgers.electrical
{
    ...
    public class PTR2TP0015Controller : ControllerBase
    {
        private string _connectionString;

        private readonly itsppisapi.Models.DataContext _context;
        public PTR2TP0015Controller(itsppisapi.Models.DataContext context)
        {
            _context = context;
        }
        ...
        public async Task<DataSet> get(string month, int vers)
        {
            try
            {
                string strqry = "[PPIS].PPU_P_TSE2_YR_DM_BF_WATER_BAL_PTR2TOP0015";
