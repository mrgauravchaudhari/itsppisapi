...
namespace cfclapi.Controllers.ledgers.electrical
{
    ...
    public class PTR2TP0905Controller : ControllerBase
    {
        private string _connectionString;

        private readonly itsppisapi.Models.DataContext _context;
        public PTR2TP0905Controller(itsppisapi.Models.DataContext context)
        {
            _context = context;
        }
        ...
        public async Task<DataSet> get(string month, int vers)
        {
            try
            {
                string strqry = "PPIS.PPU_P_TSE2_YR_PROD_DATA_PTR2TOP0905";
