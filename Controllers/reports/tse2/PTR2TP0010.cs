...
namespace cfclapi.Controllers.ledgers.electrical
{
    ...
    public class PTR2TP0010Controller : ControllerBase
    {
        private string _connectionString;

        private readonly itsppisapi.Models.DataContext _context;
        public PTR2TP0010Controller(itsppisapi.Models.DataContext context)
        {
            _context = context;
        }
        ...
        public async Task<DataSet> get(string year, int vers)
        {
            try
            {
                string strqry = "PPIS.PPU_P_TSE2_YR_DATE_PURCH_ITEM_PTR2TOP0010";
