...
namespace cfclapi.Controllers.ledgers.electrical
{
    ...
    public class PBR208Controller : ControllerBase
    {
        private string _connectionString;

        private readonly itsppisapi.Models.DataContext _context;
        public PBR208Controller(itsppisapi.Models.DataContext context)
        {
            _context = context;
        }
        ...
        public async Task<DataSet> get(string month, string unit_id)
        {
            try
            {
                string strqry = "[PPIS].[PPU_P_BG_MR_RACK_PLACEMENT_PBR208]";
