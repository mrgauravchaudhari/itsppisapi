...
namespace cfclapi.Controllers.ledgers.electrical
{
    ...
    public class PMR017Controller : ControllerBase
    {
        private string _connectionString;

        private readonly itsppisapi.Models.DataContext _context;
        public PMR017Controller(itsppisapi.Models.DataContext context)
        {
            _context = context;
        }
        ...
        public async Task<DataSet> get(string date1, string date2)
        {
            try
            {
                string strqry = "[PPIS].PPU_P_MGMT_ENERGY_RPT_GPII_PMR017";
