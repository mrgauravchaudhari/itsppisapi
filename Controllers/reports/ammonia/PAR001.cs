...
namespace cfclapi.Controllers.ledgers.electrical
{
    ...
    public class PAR001Controller : ControllerBase
    {
        private string _connectionString;

        private readonly itsppisapi.Models.DataContext _context;
        public PAR001Controller(itsppisapi.Models.DataContext context)
        {
            _context = context;
        }
        ...
        public async Task<DataSet> get(string month, string unitid)
        {
            try
            {
               string strqry = "PPIS.PPU_AM1_DR_PROD_CONS_PAR001";
