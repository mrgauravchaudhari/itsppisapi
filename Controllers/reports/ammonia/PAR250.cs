...
namespace cfclapi.Controllers.ledgers.electrical
{
    ...
    public class PAR250Controller : ControllerBase
    {
        private string _connectionString;

        private readonly itsppisapi.Models.DataContext _context;
        public PAR250Controller(itsppisapi.Models.DataContext context)
        {
            _context = context;
        }
        ...
        public async Task<DataSet> get(string month)
        {
            try
            {
                string strqry = "[PPIS].PPU_P_AM2_MR_MAINTENANCE_JOBS_PAR250";
