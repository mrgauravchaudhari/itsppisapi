...
namespace cfclapi.Controllers.ledgers.electrical
{
    ...
    public class PUR205Controller : ControllerBase
    {
        private string _connectionString;

        private readonly itsppisapi.Models.DataContext _context;
        public PUR205Controller(itsppisapi.Models.DataContext context)
        {
            _context = context;
        }
        ...
        public async Task<DataSet> get(string mnth)
        {
            try
            {
               string strqry = "[PPIS].[PPU_P_UR2_MR_DOWNTIME_ANALYSIS_PUR205]";
