...
namespace cfclapi.Controllers.ledgers.electrical
{
    ...
    public class PUR202Controller : ControllerBase
    {
        private string _connectionString;

        private readonly itsppisapi.Models.DataContext _context;
        public PUR202Controller(itsppisapi.Models.DataContext context)
        {
            _context = context;
        }
        ...
        public async Task<DataSet> get(string mnth)
        {
            try
            {
               string strqry = "PPIS.PPU_P_UR2_DR_DOWN_TIME_ANALYSIS_PUR202";
