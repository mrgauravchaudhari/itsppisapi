...
namespace cfclapi.Controllers.ledgers.electrical
{
    ...
    public class PUR004Controller : ControllerBase
    {
        private string _connectionString;

        private readonly itsppisapi.Models.DataContext _context;
        public PUR004Controller(itsppisapi.Models.DataContext context)
        {
            _context = context;
        }
        ...
        public async Task<DataSet> get(string mnth)
        {
            try
            {
                string strqry = "[PPIS].[PPU_P_UR1_MR_DOWNTIME_ANALYSIS_PUR004]";
