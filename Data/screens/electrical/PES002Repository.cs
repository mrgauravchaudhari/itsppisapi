...
namespace itsppisapi.Data
{
    public class PES002Repository
    {
        ...
        private PES002DVDto MapToValueDV(SqlDataReader reader)
        {
            return new PES002DVDto()
            {
        ...
        private PES002DV2Dto MapToValueDV2(SqlDataReader reader)
        {
            return new PES002DV2Dto()
            {
        ...
        public async Task<PES002DVDto> putDataDV(string IN_DATE)
        {
            using (SqlConnection sql = new SqlConnection(_connectionString))
            {
        ...
        public async Task<PES002DV2Dto> putDataDV2(decimal IN_SUB_COND_ID, string IN_TAB)
        {
            using (SqlConnection sql = new SqlConnection(_connectionString))
            {
